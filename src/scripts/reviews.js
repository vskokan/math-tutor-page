const reviews = [
    {   
        ...
        text: 'Преподавателем довольны, я и ребенок. Занятия проходят интересно и непринужденно. '
    },
    {
        id: 1,
        name: 'Алла',
        ...
        text: 'Преподаватель ответственный, пунктуальный. Занятиями довольны'
    },
    {
        id: 2,
        name: 'Людмила',
        ...
        text: 'Репетитор понравился. Имеет интересную и эффективную методику преподавания, доступно объясняет материал. Результаты положительные. Рекомменую.'
    },
    {
        id: 3,
        name: 'Мирослав',
    ...
    },
    {
        ...
        text: 'Хороший репетитор. Занятиями довольна.'
    },
    {
        id: 5,
        name: 'Григорий',
        rate: '5',
        title: 'Математика, подготовка к ЗНО',
        text: 'Вадим Алексанрович хороший репетитор, быстро нашел общий язык, доступно объясняет, мы полностью удовтелворены его работой.'
    },
    {
        id: 6,
        name: 'Наталья',
